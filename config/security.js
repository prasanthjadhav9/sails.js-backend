...
module.exports.security = {
  ...
  ***************************************************************************/
  ...
  cors: {
    // '*':true
       allRoutes: true,
       allowOrigins: ['http://localhost:4200', 'http://affy.rajasekhar.co', 'https://affy.rajasekhar.co', 'http://partners.indstack.com', 'https://partners.indstack.com'],
       allowCredentials: false,
       allowRequestMethods: 'GET, PATCH, POST, PUT, DELETE, OPTIONS, HEAD',
       allowRequestHeaders: 'Authorization,Accept, Origin, Content-Type,Cache-Control,X-Requested-With,x-auth-token,x-requester'
  },
